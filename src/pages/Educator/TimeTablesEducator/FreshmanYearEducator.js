...
import FreshmanYear from 'Components/TimeTables/FreshmanYear';
...
function FreshmanYearEducator(props) {
...
FreshmanYearEducator.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withSnackbar(withStyles(styles)(FreshmanYearEducator));